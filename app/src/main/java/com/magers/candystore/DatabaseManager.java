...
public class DatabaseManager extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //build sqp create statement (will create database)
    ...
    public void insert (Candy candy) { //method that will do the insert, takes param of candy object
        ...
        db.execSQL(sqlInsert); //create sql string and pass thru exec
        db.close();
    ...
    public void deleteById(int id) { //std CRUD delete code
        SQLiteDatabase db = this.getWritableDatabase();
